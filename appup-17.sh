...
echo 'Deploy with source code with mvn and github related files'
...
echo 'Deploy with source code with local builder, need to start Docker Engine first'
...
echo 'Deploy with source code from git repo'
